...
//******************************************Function to calculate lot size********************************//
   ...
   if (ma_1[0]<ma_1buy_level&&ma_2[0]<ma_2buy_level&&enve[0]<envelope_buy_level && SymbolPositionsTotal()<tradespersignal&&(trade_Type==Both_Type||trade_Type==buy)&&ma_2[0]>enve[0]&&ma_2[2]<enve[2])
      {
   ...
   if (ma_1[0]>ma_1sell_level && ma_2[0]>ma_2sell_level&&enve[0]>envelope_sell_level&&SymbolPositionsTotal()<tradespersignal&&(trade_Type==Both_Type||trade_Type==sell)&&ma_2[0]<enve[0]&&ma_2[2]>enve[2])
